...
@Component
public class GlobalRequestPreFilter implements GlobalFilter, Ordered {

	private static final Logger logger = LoggerFactory.getLogger(GlobalRequestPreFilter.class);
	...
	public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
		...
		logger.info("PRE FILTER → {} {} | IP={}", method.toString(), path, ip);
